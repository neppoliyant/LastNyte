...
doAuditLogRes = function (req, resStatusCode, responsedata) {
    var useragent = null;
    var deviceID = null;
    var uid = null;
    var uid = req.params.id || JSON.stringify(req.body) || req.query.id;
    ...
    if (array.length > 0) {
        ...
        auditlogger.originalMethod = req['originalMethod'];
        auditlogger.responsedata = responsedata;
        auditlogger.statusCode = resStatusCode;
        write(auditlogger);
    }
};

write = function(auditlogger) {
    logger.audit("resourceRequest=" + auditlogger.customurl + ", httpStatusCode="+ auditlogger.statusCode +", protocol=" + auditlogger.protocol + ", httpMethod=" + auditlogger.originalMethod + ", deviceType=" + auditlogger.deviceType + ", deviceModel=" + auditlogger.deviceModel + ", osVersion=" + auditlogger.osVersion
...
module.exports.auditlogNew = doAuditLogRes;